...
상품명:<input type=text value="${alDTO.alName}" readonly></input><br/>
수량 : <input type=hidden ondragstart='return false'  name="sell_price" value="${alDTO.alPrice}">
<input type="text" name="amount" id="amount" value="0" size="3" onkeydown="change(this);" onkeyup = "change(this);"><br/>
...
총 금액 : <a id="my_sum" value="0"></a>원<br/> 
</form>
<button class="btn_cart">장바구니 추가</button> 

<a href="/orderForm">구매하기</a>
