...
<h2 class="order-menu">주문하기</h2>
	...
	<div class="goods_kind_div">
		<p>주문상품 <span class="goods_kind_div_kind"></span>종 <span class="goods_kind_div_count"></span>개</p>
	</div>
		...
		<form action="/orderHis" method="post" class="compOrder_form">
			<table>
				...
				<tr>
					<th>배송지입력</th>
                    <td>
					<input name="userName" type="hidden" value="${SPRING_SECURITY_CONTEXT.authentication.principal.user.username }">
                    	<p>
