        	...
        	<a href="/home"><img src="/img/finallogo.png" alt="이미지" class="logo_img"></a>
				<form action="/join" method="post" onsubmit="return isSubmit.isSubmit();">
					<div class="input_aera">					
		            	아이디 : <input type="text" name="username" class="username" autofocus maxlength="20" required placeholder="아이디를 입력해 주세요" >
						<span class="msg_box">${errorMsg.username }</span>
	            	</div>          
		               
					<div class="input_aera">
						비밀번호 : <input type="password" class="password1" name="password" maxlength="20" required placeholder="비밀번호를 입력해 주세요">
					</div>
