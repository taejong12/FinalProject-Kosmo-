				...
				<div class="find">
					<div id="find_by_email">
						...
						<div class="auth" id="email_auth" >
							...
							<input type="text" class="auth_num em" name="authNum" readonly maxlength="6"  placeholder="인증번호 6자리를 입력하세요" >
					...
					<div id="find_by_phone">
						...
						<div class="auth" id="phone_auth">
							...
							<input type="text" class="auth_num1 pm" name="authNum" readonly maxlength="6"  placeholder="인증번호 6자리를 입력하세요">
							<span class="timer1"></span><br/><br/><br/><br/>
						</div>
					</div>
