...
function jumin_QC()
{
	console.log("ttest :  "+ document.jumin_form.username.value);
	if(document.jumin_form.username.value == null || document.jumin_form.username.value==""){
		alert('이름을 입력해주세요.');
		return false;
	}
  ...
  if (isNaN(document.jumin_form.jumin1.value) || isNaN(document.jumin_form.jumin2.value))
 {
  ...
  return false;
    ...
    if(mil<gijun_date){
		...
		swal("성인인증이 되었습니다.", " ", "warning").then(function(){
		location.href='/home';
		})
