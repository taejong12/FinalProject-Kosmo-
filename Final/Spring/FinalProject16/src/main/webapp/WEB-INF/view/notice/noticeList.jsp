...
<body style="font-family: 'Hahmlet', serif;">
	<section>
		...
		<div>
			...
			<table class="table table-striped-columns" id="table" width="300"
				...
				<tr id="top">
					...
					<c:if
						test="${SPRING_SECURITY_CONTEXT.authentication.principal.user.username eq 'admin'}">
				...
				<c:forEach items="${list}" var="dto">
					<tr>
						...
						<td id="noticeTitle"><a
							href="/notice/view2?noNum=${dto.noNum}">${dto.noTitle}</a></td>
						...
						<c:if
							test="${SPRING_SECURITY_CONTEXT.authentication.principal.user.username eq 'admin'}">
							<td class=noticeTb><a
								href="/notice/updateView?noNum=${dto.noNum}">❤</a></td>
							<td class=noticeTb><a
								href="/notice/delete?noNum=${dto.noNum}">◎</a></td>
						</c:if>
					</tr>
				</c:forEach>
			</table>
		...
		<div class="pageMaker_wrap">
			<ul class="pageMaker">
				...
				<c:forEach begin="${pageMaker.startPage }"
					...
					<li
						class="pageMaker_btn ${pageMaker.cri.pageNum == num ? 'active1':''}">
