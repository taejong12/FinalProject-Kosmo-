...
<body style="font-family: 'Hahmlet', serif;">
	...
	<div style="text-align:center; margin-top: 2%;"><h1 class="titlejoin">비밀번호 재설정</h1></div>
	<main class="password_modify_page" style="font-family: 'Hahmlet', serif;">
		<div class="login_box">
				<a href="/home"><img src="/img/finallogo.png" alt="이미지" class="logo_img"></a><br/><br/>
			<div class="find_info">
				<h3 style="color: white;">새로운 비밀번호로 재설정해주세요</h3>
				<br/>
				<div class="box">
