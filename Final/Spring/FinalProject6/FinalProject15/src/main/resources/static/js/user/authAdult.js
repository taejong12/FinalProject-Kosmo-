...
function jumin_QC()
{
  ...
  if (isNaN(document.jumin_form.jumin1.value) || isNaN(document.jumin_form.jumin2.value))
 {
  ...
  return false;
    ...
    console.log(mil);
    if(mil<gijun_date){
		swal("성인인증이 되었습니다.", " ", "warning");
          document.jumin_form.jumin1.focus();
		  document.location="http://localhost:8081/home ";//성인일 경우 이동할 문서의 경로
